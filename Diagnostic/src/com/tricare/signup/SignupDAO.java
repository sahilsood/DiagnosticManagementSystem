...
public class SignupDAO {
	public String addUser(SignupTO TOobj) throws SQLException {
		try {
			...
			PreparedStatement ps = con.prepareStatement("insert into usermaster values(?,?,?,?,'Patient')");
			...
			if(resultUsername.next()){
				...
				if(result != 0){
					return "Your account has been created successfully!" +
							" Kindly login to your account to use our services.";
				}
				else {
